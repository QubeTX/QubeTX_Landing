...
const ROUTING = [
  ...
  { command: 'Short text CHANGED in place', description: 'The slot roll — always (§18)' },
  ...
  { command: 'Paragraph wraps/reflows', description: 'Not a motion job — PretextBlock reserves the space (§25); blocks animate as wholes' },
]

/** §19 — Text systems. Four ways text moves, and exactly when each applies. */
