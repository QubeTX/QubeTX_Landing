...
export default function QubeTXLogo({ size, className, ...props }: QubeTXLogoProps) {
  ...
  return (
    ...
    >
      ...
      {/* Top vertical detail */}
      <g transform="matrix(1,0,0,1,7.033328,-0.065735)">
        <path d="M103.1,13.72L103.1,24.71" style={{ fill: 'none', stroke: '#0066FF', strokeWidth: '2px' }} />
      </g>
    </svg>
  )
}
